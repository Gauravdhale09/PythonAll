...
def play(x):
    ...
    win.title("Result")
    win.wm_iconbitmap('E:\MAIN\Python Learn\snakewatergun\icon.ico')
...
root.wm_iconbitmap('E:\MAIN\Python Learn\snakewatergun\icon.ico')
...
img1 = PhotoImage(file='E:\MAIN\Python Learn\snakewatergun\snake.png')
img2 = PhotoImage(file="E:\MAIN\Python Learn\snakewatergun\water.png")
img3 = PhotoImage(file="E:\MAIN\Python Learn\snakewatergun\gun.png")
b1_var = IntVar()
